            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="flex items-center justify-center space-x-4">
                        <div className={`flex items-center justify-center w-8 h-8 rounded-full ${step === 'info' ? 'bg-primary text-primary-foreground' :
                        ...
                        <div className={`flex items-center justify-center w-8 h-8 rounded-full ${step === 'documents' ? 'bg-primary text-primary-foreground' :
                        ...
                        <div className={`flex items-center justify-center w-8 h-8 rounded-full ${step === 'verification' ? 'bg-primary text-primary-foreground' : 'bg-gray-200 text-gray-600'
                            }`}>
                            3
                        </div>
                    </div>
